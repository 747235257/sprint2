...
namespace sprint2
{
    public class wep1 : IItem
    {
        ...
        public wep1(Vector2 pos, Game1 game, SpriteBatch spriteBatch)
        {
            this.game = game;
            itemSprite = new NonMoveAnimatedSprite(game.Content.Load<Texture2D>("wep1hud"), 1, 1, pos);
