...
namespace sprint2
{
    public class wep3 : IItem
    {
        ...
        public wep3(Vector2 pos, Game1 game, SpriteBatch spriteBatch)
        {
            this.game = game;
            itemSprite = new NonMoveAnimatedSprite(game.Content.Load<Texture2D>("wep3hud"), 1, 1, pos);
